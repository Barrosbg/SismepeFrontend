...
const ModalConcentradoPlaquetas= (props) => {
    ...
    return(
        ...
        >
            <Grid container spacing={2} margin="dense" >
                ...
                <Grid item xs={12} md={1.8} ><div className="Spacer"></div>
                    Plaquetas/mm³*
                    <div>
                        <TextField
                        label="P. /mm³*"
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalConcentradoPlaquetas)