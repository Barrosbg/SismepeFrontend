                     ...
                     <Grid container spacing={5} margin="dense" >
                        ...
                        <Grid item xs={12} md={1.8} >
                            ...
                            <div className="Spacer"></div>
                             <div>
                               <input type="checkbox"  name="desleucocitados" value="desleucocitados" />Desleucocitados
                             </div>
                             <div>
                                <input type="checkbox"  name="filtrado" value="filtrado" />Filtrado
                             </div>
                             <div>
                               <input type="checkbox"  name="lavado" value="lavado" />Lavado
                             </div>
                             <div>
                               <input type="checkbox"  name="fenotipado" value="filtrado" />Fenotipado
                             </div>
                             <div>
                               <input type="checkbox"  name="irradiado" value="irradiado" />Irradiado
                             </div>
                        </Grid>
