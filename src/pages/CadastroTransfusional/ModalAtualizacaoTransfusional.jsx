...
const ModalCadastroTransfusional  = (props) => {

let valorAtualizar = props.idAtualizar;
    ...
    // const [idAtualizar, setIdAtualizar] = useState(props.setIdAtualizar)

    //  const handleChangeSetModalOpen = (event) => {
    //     setModalOpen(false);
    // };
...
//  },[])
    ...
    const handleAtualizarTranfusional = async () => {
        ...
        if (matricula != "" && cdPessoa != "" && cdOrgao != "") {
            ...
            props.fetchBackdrop('BACKDROP_FETCHED', true);
            let response = await atualizarCadastroTransfusional(valorAtualizar, payload)
            props.fetchBackdrop('BACKDROP_FETCHED', false);
            // console.log(response.status)
            // console.log(response)
    ...
    return (
        ...
        title="Cadastro Transfusional"
        cancelAction={() =>closeFunction()}
        
        okAction={atualizarCadastro? handleAtualizarTranfusional : handleSalvarTranfusional}
        okLabel={nomeBotao? "Atualizar" : "Salvar"} 
        >
                ...
                <CardContent>
                    <Grid container spacing={1} margin="dense" >
                        <Grid item xs={12} md={6}>
                            <Button variant="contained" color="secondary" fullWidth onClick={closeFunction}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCadastroTransfusional)
