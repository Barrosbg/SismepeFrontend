...
const TelaCadastro01Transfusional  = (props) => {
    ...
    //  dadosTeste.cadastro = valorAtualizar;
    //  dadosTeste.tipo = atualizar.hemocompTipo;
    
    //  console.log(dadosTeste.cadastro+" - "+ dadosTeste.tela)
    ...
    // console.log(dadosTeste.cadastro+" - "+dadosTeste.tipo)
...
export default connect(mapStateToProps, mapDispatchToProps)(TelaCadastro01Transfusional)
