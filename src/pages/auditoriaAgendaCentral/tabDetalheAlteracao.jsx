                        ...
                        <Grid item sm={12} md={12}  >
                            ...
                            <Grid container spacing={1} >
                                <Grid item xs={12} sm={2} >
                                    <TextField id="outlined-basic" label="Ativa" value={props.escala?.escala.ativo === 'S' ? "SIM" : "NÃO"} disabled variant="outlined" placeholder="Usuário" fullWidth={true} margin="dense" />
                                </Grid>
                                <Grid item xs={12} sm={6} >
                                    <TextField id="outlined-basic" label="Data de inclusão" value={props.escala?.escala.dataInclusao} disabled variant="outlined" placeholder="Usuário" fullWidth={true} margin="dense" />
                                </Grid>
                                <Grid item xs={12} sm={4} >
                                    <TextField id="outlined-basic" label="Data de Alteração" value={props.escala?.escala.dataAlteracao} disabled variant="outlined" placeholder="Titular" fullWidth={true} margin="dense" />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetalhesAlteracao)
